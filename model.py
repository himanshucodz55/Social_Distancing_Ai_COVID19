...
#         print(type(boxes),type(class_ids),type(scores),type(masks))
#         print(class_ids)
...
#                 class_ids1.append(class_ids[i])
#                 scores1.append(scores[i])
#                 full_masks1.append(full_masks[:,:,i])
                
#         boxes=np.array(boxes1).astype(np.int32) 
#         class_ids=np.array(class_ids1).astype(np.int32)
#         scores=np.array(scores1).astype(np.int32)
#         full_masks=np.array(full_masks1).astype(np.int32)
